...
CHECK_USER_TIMEOUT = _get_float("CHECK_USER_TIMEOUT_SECONDS", 20.0)
CHECK_USER_CONNECT_TIMEOUT = _get_float("CHECK_USER_CONNECT_TIMEOUT_SECONDS", 10.0)
CHECK_USER_MAX_ATTEMPTS = _get_int("CHECK_USER_MAX_ATTEMPTS", 2)

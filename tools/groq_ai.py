...
def extract_full_intent(
    ...
    system = (
        ...
        "  1. 'ugc_presentation' — user talks/presents AND the product/property/photos are shown "
        "behind or alongside them. Signals: 'with my property in the background', 'product behind me', "
        "'me presenting the listing', 'talking with photos behind', 'presentation video', "
        "'presenter video', 'me showing the property/product'. If the user mentions BOTH appearing "
        "on camera AND a product/property/link being shown, choose 'ugc_presentation'.\n"
        "  2. 'ugc' — user just talks to camera, NO product visuals behind: 'ugc', 'talking head', "
        "'talking video', 'video of me', 'me talking', 'selfie video', 'my face', 'vlog' "
        "(with no mention of product/photos shown behind).\n"
